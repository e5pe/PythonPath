...
number is even (par), then collatz() should print number // 2 and return this value.
If number is odd (impar), then collatz() should print and return 3 * number + 1 .
